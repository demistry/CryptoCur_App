...
public class ExchangeLoaderClass extends AsyncTaskLoader<String> {
    private static final String url = "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=BTC,ETH,SBD,LTC,XRP,BCH&tsyms=USD,GBP,EUR,NGN,CHF,JPY,INR,CAD,AUD,IQD,CNY,ZAR,NZD,RUB,SGD,SEK,KWD,MXN,TRY,BRL";
